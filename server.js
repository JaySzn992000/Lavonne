...
app.get("/fetchcream", async (req, res) => {

const query = `
SELECT *
FROM _imgproduct
WHERE img ILIKE '%cream%'
`;
...
app.get("/fetchfruit", async (req, res) => {
...
app.get("/fetchnewarrivalcake", async (req, res) => {

const query = `
SELECT *
FROM _imgproduct
WHERE img ILIKE '%new arrival%'
`;
